...
public class REQUEST {
    public static final int U2S_PROMOTION_INFO = 95;
    public static final int U2S_FAVORITE_INFO = 100;
    ...
    public static int MAIL_INFO = 115;
    public static int U2S_VIP_EXP_REQ = 91;
    public static int U2S_JACKPOT_REQ = 25;
